...
$(document).ready(function() {
    ...
    for (var i = 0; i < tables.length; ++i) {
        ...
        for (var j = 0; j < tables[i].tHead.rows[0].cells.length; ++j) {
            ...
            th.innerHTML += " <img style=\"vertical-align:middle\" src=\"../../../../../images/http/sort_none.gif\"/>";
        }
...
function sortTable() {
    ...
    function continuation() {
        if ($(el).hasClass('sorted')) {
            ...
            el.getElementsByTagName('img')[0].setAttribute( 'src', '../../../../../images/http/sort_up.gif');
            reverseRows(el.sortTable);
        }
        else if ($(el).hasClass('reversed')) {
            $(el).removeClass('reversed');
            $(el).addClass('sorted');
            el.getElementsByTagName('img')[0].setAttribute('src', '../../../../../images/http/sort_down.gif');
            reverseRows( el.sortTable );
        }
        else {
            var rows = [];
            ...
            for ( var i = 0; i < imgs.length; ++i )
                imgs[i].setAttribute('src', '../../../../../images/http/sort_none.gif');
